...
if (isset($_POST['verify'])) {
    ...
    // Query the admin table for matching email or phone
    $query = "SELECT * FROM admin WHERE email = ? OR contact = ?";
...
if (isset($_POST['reset_password'])) {
    ...
    if ($_SESSION['otp'] == $otp) {
        if ($new_password === $confirm_password) {
            ...
            $query = "UPDATE admin SET password = ? WHERE email = ? OR contact = ?";
            ...
            if ($stmt) {
                ...
                echo "<script>window.location.href='logina.php';</script>";
            } else {
...
if (isset($_POST['change_email'])) {
    ...
    echo "<script>window.location.href='aforget-password.php';</script>";
}
?>
    ...
    <main>
        <div class="form-container">
            ...
            <?php if (!isset($_SESSION['otp'])): ?>
                <form action="aforget-password.php" method="POST">
